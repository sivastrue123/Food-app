...
DROP POLICY IF EXISTS "Anyone can view employee history" ON employee_history;
CREATE POLICY "Anyone can view employee history" ON employee_history FOR SELECT USING (true);

DROP POLICY IF EXISTS "Admins can manage employee history" ON employee_history;
...
DROP POLICY IF EXISTS "Anyone can view inventory" ON outlet_inventory;
CREATE POLICY "Anyone can view inventory" ON outlet_inventory FOR SELECT USING (true);

DROP POLICY IF EXISTS "Admins can manage inventory" ON outlet_inventory;
...
DROP POLICY IF EXISTS "Anyone can view payment records" ON payment_records;
CREATE POLICY "Anyone can view payment records" ON payment_records FOR SELECT USING (true);

DROP POLICY IF EXISTS "Admins can manage payments" ON payment_records;
