        ...
        <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600 mt-1">Manage all your hotel locations</p>
            </div>
            {user.role === 'admin' && (
              <button
        ...
        <div className="p-8">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-2">No outlets yet</h3>
              <p className="text-slate-600 mb-6">Get started by adding your first outlet location</p>
              {user.role === 'admin' && (
                <button
                  onClick={() => setShowModal(true)}
