          ...
          {loading ? (
            <div className="flex items-center justify-center py-12">
              <div className="flex flex-col items-center gap-3">
                <svg className="animate-spin h-9 w-9 text-purple-600" fill="none" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-1">No employees yet</h3>
              <p className="text-slate-600 text-sm mb-4">Get started by adding your first employee</p>
              <button
                onClick={() => setShowModal(true)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {employees.map((employee) => (
                <PageCard key={employee.id} interactive className="group">
                  ...
                  <div className="px-4 -mt-10 relative z-10">
                    <div 
                      className="w-16 h-16 rounded-full flex items-center justify-center text-white font-bold text-lg border-2 border-white shadow-md"
                  ...
                  <div className="px-4 pb-4 pt-2">
                    <h3 className="text-base font-bold text-slate-900 mb-1">{employee.name}</h3>
                    
                    {/* Position Badge */}
                    <div className="mb-3">
                      <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-semibold ${getRoleBadgeColor(employee.position)}`}>
                        {employee.position}
                      </span>
                    </div>
                    ...
                    {/* Salary */}
                    {employee.salary && (
                      <div className="mb-3 p-2 rounded-md bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200">
                    ...
                    <div className="flex gap-2 pt-3 border-t border-gray-100">
                      <button
                        ...
                        className="flex-1 px-3 py-1.5 rounded-md text-xs font-medium text-purple-700 bg-purple-50 hover:bg-purple-100 transition-colors flex items-center justify-center gap-1.5"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 px-3 py-1.5 rounded-md text-xs font-medium text-red-700 bg-red-50 hover:bg-red-100 transition-colors flex items-center justify-center gap-1.5"
                      >
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
